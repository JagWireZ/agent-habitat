...
- `broken_kata_install_fails_closed_with_distinct_tag` -- the
  broken-containerd/Kata exit-gate scenario.
...
probe, containerd/nerdctl, Kata/Firecracker) stay as inline
