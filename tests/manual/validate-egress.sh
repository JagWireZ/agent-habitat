...
record "(Phase 7 now wires this into \`habitat run\`'s own lifecycle -- see"
record "tests/manual/validate-habitat-run.sh for the end-to-end version; this harness is"
